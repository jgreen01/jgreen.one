...
export const GET: APIRoute = async () => {
  const published = sortByDate(filterByKind(filterDrafts(await getCollection("entries")), "blog"));
  ...
  return new Response(listingMarkdown({
    title: "Blog",
    description: "Writing about AI, infrastructure and building software.",
    path: "/blog/",
    entries: listed,
  }), {
    headers: {
